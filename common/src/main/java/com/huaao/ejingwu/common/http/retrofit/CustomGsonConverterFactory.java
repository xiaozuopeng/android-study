...
public class CustomGsonConverterFactory extends Converter.Factory {
    ...
    private class CustomGsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
        ...
        public T convert(ResponseBody value) throws IOException {
            ...
            ResponseEntity entity = gson.fromJson(response, ResponseEntity.class);
            if (HttpErrorCode.SUCCESS_CODE != entity.getCode()) {
                value.close();
                throw new ResultException(entity.getCode(), entity.getMsg());
            }
